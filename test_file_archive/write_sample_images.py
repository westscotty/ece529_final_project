...
def save_frames(input_video_path, output_image_dir="extracted_frames"):
    ...
    while True:
        ...
        # Save every 25th frame as a PNG
        if frame_id % 50 == 0:
    ...
    # Release resources
    cap.release()
    print(f"Finished extracting frames. Total frames saved: {frame_id // 25}.")

# Example usage
video_file = 'data/videos/blue_angels_formation.mp4'
new_image_dir = f'data/extracted_frames/{video_file.rsplit('/', maxsplit=1)[-1].split(".")[0]}'
