...
Work was started on introducing more image operations into the custom NumPy algorith utilizing histogram equalizations and other filter types such as a median filter. Basic code was developed to implement these ideas, but the time was not there to assess. 
\bigskip
